...
class IMRPhenomD(TaylorF2):
    ...
    def phenom_d_amp(
        ...
        mrd_amp, mrd_Damp = self.phenom_d_mrd_amp(Mf, eta, eta2, chi1, chi2, xi)
    ...
    def phenom_d_int_amp(self, Mf, eta, eta2, Seta, chi1, chi2, chi12, chi22, xi):
        # merger ringdown
        fRD, fDM = self.fring_fdamp(eta, eta2, chi1, chi2)
    ...
    def phenom_d_phase(self, Mf, mass_1, mass_2, eta, eta2, chi1, chi2, xi):
        ...
        mrd_phase, mrd_Dphase = self.phenom_d_mrd_phase(Mf, eta, eta2, chi1, chi2, xi)
