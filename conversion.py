...
from types_ml4gw import BatchTensor
...
def XLALSimInspiralLN(total_mass: BatchTensor, eta: BatchTensor, v: BatchTensor):
    """
...
def bilby_spins_to_lalsim(
    ...
    s1hatx, s1haty, s1hatz = rotate_z(PI / 2.0 - phiN - phi_ref, s1hatx, s1haty, s1hatz)
    s2hatx, s2haty, s2hatz = rotate_z(PI / 2.0 - phiN - phi_ref, s2hatx, s2haty, s2hatz)
